...
class init_variables():
    ...
    def __init__(self, __def_path__=None):
        ...
        self.nonimaging_subjectlevel_data = os.path.join(
            self.main_dir, 'eses_subjects_202008.csv')
...
# TODO see if there is a better way to make sure the shared module exists
# and can be loaded.
init_variables()
