...
def calculate_graph_msrs(G, subgraph_name=None, prop_thr=None):
    ...
    G)
        ...
        G, communities),
        'gm_shortest_path' = nx.algorithms.shortest_paths.generic.average_shortest_path_length(
        G, method='dijkstra'),
        'gm_local_efficiency' = nx.algorithms.efficiency_measures.local_efficiency(
        G)
